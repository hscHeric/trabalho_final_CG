...
public:
  ...
  static void drawOriQuad( float angle       = 0.0,
                           ...
                           float texHeight   = 5.0,
                           bool  inverted    = false );
  static void drawQuadBox(
    float xmin, float ymin, float zmin, float xmax, float ymax, float zmax, float discrWidth = 0.3, float discrHeight = 0.3, bool inverted = false );
